...
interaction_model <- lm(sum_Length ~ percent_res_new + binary_white + log_pop_density + med_income_E + percent_bike, bikeways3)
...
```{r}
interact_plot(interaction_model, pred = percent_res_new, modx = majority_vote,
              interval = TRUE) +
