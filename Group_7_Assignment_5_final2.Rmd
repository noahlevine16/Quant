...
Prior to starting Assignment 5, we wanted to tidy up our previous data and add new variables to explore. We also confirmed that we were using a more restrictive definition of bikeway infrastructure, whiches excluding sharrows and other infrastructure that is not a bike lane separated from vehicular traffic.  
